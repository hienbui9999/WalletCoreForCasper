...
TEST(TWAnySignerFilecoin, Sign) {
   ...
   // auto privateKey = parse_hex("1d969865e189957b9824bd34f26d5cbf357fda1a6d844cbf0c9ab1ed93fa7dbe");
    auto privateKey = parse_hex("954b81a59283ec5bcf7186148f9f8b2f1cdfb62ebbf54652ef6a246d6fcc65f2");
    //auto toAddress =
        "f3um6uo3qt5of54xjbx3hsxbw5mbsc6auxzrvfxekn5bv3duewqyn2tg5rhrlx73qahzzpkhuj7a34iq7oifsq";
        auto toAddress =
        "0152a685e0edd9060da4a0d52e500d65e21789df3cbfcb878c91ffeaea756d1c53";
    uint64_t nonce = 2;
    // 600 FIL
    ...
    auto outputData = WRAPD(TWAnySignerSign(inputData.get(), TWCoinTypeCasper2));
...
TEST(TWAnySignerFilecoin, SignJSON) {
    auto json = STRING(
        R"({
            ...
            "gasPremium": "K1468WsYgBBB"
        })");//K1468WsYgAAA
   // auto key = DATA("1d969865e189957b9824bd34f26d5cbf357fda1a6d844cbf0c9ab1ed93fa7dbe");
    auto key = DATA("954b81a59283ec5bcf7186148f9f8b2f1cdfb62ebbf54652ef6a246d6fcc65f2");
    auto result = WRAPS(TWAnySignerSignJSON(json.get(), key.get(), TWCoinTypeCasper2));

    ASSERT_TRUE(TWAnySignerSupportsJSON(TWCoinTypeCasper2));
