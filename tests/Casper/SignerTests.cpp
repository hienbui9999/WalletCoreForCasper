...
#include "Casper/OperationList.h"
#include "Casper/Signer.h"
...
TEST(TezosSigner, SignOperationList) {
    ...
    auto op_list = Casper::OperationList(branch);
    ...
    auto delegateOperationData = new Casper::Proto::DelegationOperationData();
