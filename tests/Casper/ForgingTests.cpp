...
#include "PublicKey.h"
#include "Casper/Address.h"
#include "Casper/BinaryCoding.h"
#include "Casper/Forging.h"
...
TEST(Forging, ForgeMichelsonFA12) {
    Casper::Proto::FA12Parameters data;
...
TEST(TezosTransaction, forgeTransaction) {
    auto transactionOperationData = new TW::Casper::Proto::TransactionOperationData();
    transactionOperationData->set_amount(1);
    transactionOperationData->set_destination("tz1Yju7jmmsaUiG9qQLoYv35v5pHgnWoLWbt");

    auto transactionOperation = TW::Casper::Proto::Operation();
    ...
    transactionOperation.set_kind(TW::Casper::Proto::Operation::TRANSACTION);
...
TEST(TezosTransaction, forgeReveal) {
    ...
    auto revealOperationData = new TW::Casper::Proto::RevealOperationData();
    revealOperationData->set_public_key(publicKey.bytes.data(), publicKey.bytes.size());

    auto revealOperation = TW::Casper::Proto::Operation();
    ...
    revealOperation.set_kind(TW::Casper::Proto::Operation::REVEAL);
...
TEST(TezosTransaction, forgeDelegate) {
    auto delegateOperationData = new TW::Casper::Proto::DelegationOperationData();
    delegateOperationData->set_delegate("tz1RKLoYm4vtLzo7TAgGifMDAkiWhjfyXwP4");

    auto delegateOperation = TW::Casper::Proto::Operation();
    ...
    delegateOperation.set_kind(TW::Casper::Proto::Operation::DELEGATION);
